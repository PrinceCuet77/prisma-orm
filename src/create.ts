  ...
  const reviewsData = [
    {
      ...
      movieId: createdMovies.find((m) => m.name === 'The Shawshank Redemption')
        ?.id,
    },
    {
      ...
      movieId: createdMovies.find((m) => m.name === 'The Dark Knight')?.id,
    },
    {
      ...
      movieId: createdMovies.find((m) => m.name === 'Pulp Fiction')?.id,
    },
    {
      ...
      movieId: createdMovies.find((m) => m.name === 'Forrest Gump')?.id,
    },
    {
      ...
      movieId: createdMovies.find((m) => m.name === 'Inception')?.id,
    },
    {
      ...
      userId: createdUsers[0]?.id,
      movieId: createdMovies.find((m) => m.name === 'The Matrix')?.id,
    },
    {
      ...
      userId: createdUsers[1]?.id,
      movieId: createdMovies.find((m) => m.name === 'Goodfellas')?.id,
    },
    {
      ...
      userId: createdUsers[2]?.id,
      movieId: createdMovies.find((m) => m.name.includes('Fellowship'))?.id,
    },
  ...
  const favoriteRelations = [
    {
      userId: createdUsers[0]?.id,
      movieIds: [
        createdMovies.find((m) => m.name === 'The Shawshank Redemption')?.id,
        createdMovies.find((m) => m.name === 'Pulp Fiction')?.id,
      ].filter((id): id is string => Boolean(id)),
    },
    {
      userId: createdUsers[1]?.id,
      movieIds: [
        createdMovies.find((m) => m.name === 'The Dark Knight')?.id,
        createdMovies.find((m) => m.name === 'Inception')?.id,
        createdMovies.find((m) => m.name === 'Goodfellas')?.id,
      ].filter((id): id is string => Boolean(id)),
    },
    {
      userId: createdUsers[2]?.id,
      movieIds: [
        createdMovies.find((m) => m.name === 'Pulp Fiction')?.id,
        createdMovies.find((m) => m.name.includes('Fellowship'))?.id,
      ].filter((id): id is string => Boolean(id)),
    },
  ];
